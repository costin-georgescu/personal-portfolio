...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    // Auto-fetch weather for default city (London)
...
async function fetchWeatherData(city) {
    try {
        ...
        (0, _forecastJs.updateForecastChart)(forecastData);
...
function updateCurrentWeather(data) {
    ...
    document.querySelector('.temperature').textContent = `${Math.round(data.main.temp)}\xb0F`;
    ...
    details[1].textContent = `${Math.round(data.wind.speed)} mph`;
}
...
function updateForecastDays(forecastData) {
    ...
    const dailyForecasts = (0, _forecastJs.processForecastData)(forecastData);
    ...
    dailyForecasts.forEach((dayForecast, index)=>{
        ...
        forecastDayEl.innerHTML = `
            ...
            <div class="humidity">Humidity<br>${dayForecast.humidity}%</div>
        `;
        forecastContainer.appendChild(forecastDayEl);
    });
}

},{"./forecast.js":"vIbQp"}],"d8NN9":[function(require,module,exports,__globalThis) {
